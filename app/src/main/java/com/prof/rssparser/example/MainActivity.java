...
public class MainActivity extends AppCompatActivity {
    ...
    private String urlString =  "https://vnexpress.net/rss/thoi-su.rss";
    ...
    public void ThoiSu(View view) {
        urlString = "https://vnexpress.net/rss/thoi-su.rss";
        loadFeed();
    }

    public void GiaiTri(View view) {
        urlString = "https://vnexpress.net/rss/giai-tri.rss";
        loadFeed();
    }

    public void Cuoi(View view) {
        urlString = "https://vnexpress.net/rss/cuoi.rss";
        loadFeed();
    }
}
